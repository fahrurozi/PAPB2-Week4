...
public class MainActivity extends AppCompatActivity {
    ...
    public void updateNotification(){
        ...
        builder.setStyle(new NotificationCompat.BigPictureStyle().bigPicture(mascotBitmap).setBigContentTitle("The Notification has been updated"));

        Intent contentIntent = new Intent(getApplicationContext(), MainActivity.class);
        PendingIntent pendingContentIntent = PendingIntent.getActivity(getApplicationContext(), NOTIF_ID, contentIntent, PendingIntent.FLAG_ONE_SHOT);
        builder.setContentIntent(pendingContentIntent);
